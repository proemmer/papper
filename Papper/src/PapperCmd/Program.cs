...
namespace PapperCmd
{
    ...
    public class Program
    {
        public static void Main(string[] args)
        {
            ...
            var result = papper.Read("DB_InaxSafety", "SafeMotion.Header.NumberOfActiveSlots");
        ...
        private static bool Papper_OnRead(string selector, int offset, int length, byte[] data, int targetOffset = 0)
        {
            return true;
        }
    }
